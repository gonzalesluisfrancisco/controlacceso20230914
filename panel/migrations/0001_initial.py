    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('motivo_cese', models.CharField(default='', max_length=50, null=True)),
                ...
                ('correo', models.CharField(default='', max_length=50, null=True)),
                ('n_celular', models.CharField(default='', max_length=50, null=True)),
            ],
            options={
                'db_table': 'Historial',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('motivo_cese', models.CharField(blank=True, default='', max_length=50, null=True)),
                ('cargo', models.CharField(max_length=50)),
                ('card_id', models.CharField(max_length=8)),
                ('area', models.CharField(max_length=50)),
                ('servicio', models.CharField(max_length=50)),
                ...
                ('n_celular', models.CharField(blank=True, default='', max_length=50, null=True)),
            ],
            options={
                'db_table': 'LiveData',
            },
